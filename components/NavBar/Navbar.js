...
const Navbar = () => {
  ...
  return (
    <>
    {toggle?<button onClick={toggleHandler} className="absolute z-10">
      <h1>X</h1>
    </button>:""}
      ...
      </div>: <button onClick={toggleHandler} className='md:hidden absolute'>show nav manue</button>}
      ...
      >
        <div className="md:flex md:flex-row h-[32%] md:h-12 md:bg-red-400">
          ...
          <div className="md:mt-0 md:ml-5">
            <h3 className="md:text-xl text-white">
              Mohammad Parvez Musharaf
            </h3>
